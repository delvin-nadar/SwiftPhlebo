...
export const ZoneManagement: React.FC = () => {
  ...
  const handleCreateZone = (e: React.FormEvent) => {
    ...
    addZone({
      name,
      pincodes,
      description: `${name} fulfillment area in Visakhapatnam`,
      centerCoordinates: {
        lat: parseFloat(centerLat) || 17.72,
        lng: parseFloat(centerLng) || 83.3
      }
    });
            ...
            >
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center space-x-1.5 text-xs text-slate-400 mt-0.5">
                      ...
                      <span>{zone.centerCoordinates ? `${zone.centerCoordinates.lat.toFixed(3)}° N, ${zone.centerCoordinates.lng.toFixed(3)}° E` : 'Visakhapatnam'}</span>
                    </div>
                  </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 space-y-3">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-slate-400 font-mono">20m buffer</span>
                </div>
